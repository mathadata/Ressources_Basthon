...
run_js("""
    ...
    const mathadata = {
        ...
        setup_tips(id, params) {
            ...
            params = JSON.parse(params)
            const {labels, c_train, estimations, mode, window: windowSizeParam, show_carac, show_rep} = params
...
validation_code_eleve = MathadataValidate(success="Bravo, c'est un excellent pourcentage d'erreur ! Tu as fini ce notebook.")
